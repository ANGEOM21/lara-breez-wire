                                                                                            ...
                                                                                            <tr>
                                                                                                <td
                                                                                                    ...
                                                                                                    <a target="_blank"
                                                                                                        ...
                                                                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #85b82c; border-bottom: 8px solid #85b82c; border-left: 18px solid #85b82c; border-right: 18px solid #85b82c; border-top: 8px solid #85b82c;">Verify
                                                                                                        Email
                                                                                                        Address</a>
                                                                                                </td>
                                                                                            </tr>
