                            ...
                            <tr>
                                <td class="header"
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: center; gap: 10px">
                                        ...
                                        <h1
                                            style="font-family: inherit; box-sizing: border-box; font-size: 18px; font-weight: bold; margin-top: 0; color: #3d4852">
                                            {{ $name }}
                                        </h1>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="body" width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <table class="inner-body" align="center" width="570" cellpadding="0"
                                        ...
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px; background-color: #ffffff; border-color: #e8e5ef; border-radius: 15px; border-width: 1px; box-shadow: 0 2px 0 rgba(0, 0, 150, 0.025), 2px 4px 0 rgba(0, 0, 150, 0.015); margin: 0 auto; padding: 0; width: 570px;">
                                        <!-- Body content -->
                                        <tbody>
                                            <tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td
                                                                                                    ...
                                                                                                    <a target="_blank"
                                                                                                        ...
                                                                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #85b82c; border-bottom: 8px solid #85b82c; border-left: 18px solid #85b82c; border-right: 18px solid #85b82c; border-top: 8px solid #85b82c;">Reset your password</a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
